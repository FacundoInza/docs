...
<CardGroup cols={2}>
  ...
  <Card title="Mobile" icon="mobile-screen-button" href="/modules/automatic-payments/mobile">
    The Silver5 desktop app operates the bank app on **Android phones** (the BlueStacks emulator or real phones over USB). Ideal for banks that only operate from their mobile app, with one account per phone and several paying in parallel.
  </Card>
</CardGroup>
