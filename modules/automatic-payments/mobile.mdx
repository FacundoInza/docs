...
<Frame caption="Video tutorial — Full step-by-step setup">
...
If you'd rather follow it all in one go, this video walks through the full setup end to end. The steps below are that same walkthrough in writing, with a short video in each section.
...
<CardGroup cols={2}>
  <Card title="Silver5 app — Windows" icon="windows" iconType="brands" href="https://github.com/silver5ai/silver5-downloads/releases/latest/download/Silver5-Payments.exe">
    Windows installer (`.exe`).
  </Card>

  <Card title="Silver5 app — Mac" icon="apple" iconType="brands" href="https://github.com/silver5ai/silver5-downloads/releases/latest/download/Silver5-Payments-mac.zip">
...
<Frame caption="Video tutorial — Generate the token and connect the app">
  <iframe width="100%" height="400" src="https://www.youtube-nocookie.com/embed/HupN_BRdkmc" title="Generate token and connect the app" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen />
</Frame>
...
## 5. Set up a banking integration

<Frame caption="Video tutorial — Onboard a bank / banking integration">
  <iframe width="100%" height="400" src="https://www.youtube-nocookie.com/embed/WKPAWp9JMeM" title="Onboard a bank / banking integration" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen />
</Frame>
