...
<AccordionGroup>
  <Accordion title="Test payment (dry-run)" icon="flask">
    ...
    <Frame caption="Video tutorial — Test payment (dry-run)">
      <iframe width="100%" height="400" src="https://www.youtube-nocookie.com/embed/PLACEHOLDER_V07_DRYRUN" title="Test payment (dry-run)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen />
    </Frame>
  </Accordion>
  ...
  <Accordion title="Stop an automation" icon="stop">
    ...
    <Frame caption="Video tutorial — Stop an automation">
      <iframe width="100%" height="400" src="https://www.youtube-nocookie.com/embed/PLACEHOLDER_V09_DETENER" title="Stop an automation" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen />
    </Frame>
  </Accordion>
</AccordionGroup>
