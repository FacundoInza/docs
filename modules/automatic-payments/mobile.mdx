...
<CardGroup cols={2}>
  <Card title="Silver5 app — Windows" icon="windows" iconType="brands" href="PLACEHOLDER_SILVER5_WIN">
    Windows installer (`.exe`).
  </Card>
  <Card title="Silver5 app — Mac" icon="apple" iconType="brands" href="PLACEHOLDER_SILVER5_MAC">
    macOS installer (`.dmg`).
  </Card>
</CardGroup>
...
<Note>
  The Silver5 desktop app download links (`PLACEHOLDER_SILVER5_WIN` / `PLACEHOLDER_SILVER5_MAC`) are pending: replace them with the real public installer URLs once hosted.
</Note>

## 1. Connect the app to Silver5 (token)

<Frame caption="Video tutorial — Generate the token and connect the app">
  <iframe width="100%" height="400" src="https://www.youtube.com/embed/1eJ3R7OQ6Vc" title="Generate token and connect the app" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen />
</Frame>
...
<Tabs>
  <Tab title="Real phone (USB)">
    <Frame caption="Video tutorial — Connect the device over USB">
      <iframe width="100%" height="400" src="https://www.youtube.com/embed/PLACEHOLDER_V03_USB" title="Connect the device over USB" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen />
    </Frame>
  ...
  <Tab title="Emulator (BlueStacks)">
    <Frame caption="Video tutorial — Connect the device with BlueStacks">
      <iframe width="100%" height="400" src="https://www.youtube.com/embed/X4ViKN83hMI" title="Connect the device with BlueStacks" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen />
    </Frame>
...
<Frame caption="Video tutorial — Onboard a bank / banking integration">
  <iframe width="100%" height="400" src="https://www.youtube.com/embed/j1yHWitzNdg" title="Onboard a bank / banking integration" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen />
</Frame>
...
<Frame caption="Video tutorial — Load the bank credential">
  <iframe width="100%" height="400" src="https://www.youtube.com/embed/kQ_VbVdqUac" title="Load the bank credential" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen />
</Frame>
...
When an order comes in, the app **loads and validates** the data against the order and shows a preview. You have several modes:

<AccordionGroup>
  <Accordion title="Test payment (dry-run)" icon="flask">
    ...
    <Frame caption="Video tutorial — Test payment (dry-run)">
      <iframe width="100%" height="400" src="https://www.youtube.com/embed/PLACEHOLDER_V07_DRYRUN" title="Test payment (dry-run)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen />
    </Frame>
  </Accordion>

  <Accordion title="Automatic payment" icon="bolt">
  ...
  <Accordion title="Manual confirmation" icon="hand">
    ...
    <Frame caption="Video tutorial — Manual confirmation">
      <iframe width="100%" height="400" src="https://www.youtube.com/embed/PLACEHOLDER_V08_MANUAL" title="Manual confirmation" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen />
    </Frame>
  </Accordion>
  ...
  <Accordion title="Stop an automation" icon="stop">
    ...
    <Frame caption="Video tutorial — Stop an automation">
      <iframe width="100%" height="400" src="https://www.youtube.com/embed/PLACEHOLDER_V09_DETENER" title="Stop an automation" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen />
    </Frame>
  </Accordion>
</AccordionGroup>
