...
<CardGroup cols={2}>
  <Card title="Silver5 app — Windows" icon="windows" iconType="brands" href="https://github.com/FacundoInza/silver5-downloads/releases/latest/download/silver-recon.exe">
    Windows installer (`.exe`).
  </Card>
  <Card title="Silver5 app — Mac" icon="apple" iconType="brands" href="https://github.com/FacundoInza/silver5-downloads/releases/latest/download/silver-recon-mac.zip">
